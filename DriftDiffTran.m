...
Simulation = 'Justin_park_LG'; %linear gradient
% Simulation = 'Justin_park_EG'; % exponential gradient
...
elseif strcmp(Simulation, 'Justin_park_LG')
    eval('SetGaussian2CarParasRCOnlyLinearGradient');
elseif strcmp(Simulation, 'Justin_park_EG')
